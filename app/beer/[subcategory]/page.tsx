...
interface BeerSubcategoryPageProps {
  params: {
    subcategory: string;
  };
}
...
export default async function BeerSubcategoryPage({ params }: BeerSubcategoryPageProps) {
  const { subcategory } = await params;
  
  // Get all beer products and filter by subcategory
  ...
  const subcategoryData = subcategoryInfo[subcategory] || {
    ...
    description: `Premium ${subcategory} beers`,
      ...
      <div className={`bg-gradient-to-r ${subcategoryData.color} text-white py-16`}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center mb-6">
            <Link href="/beer" className="flex items-center text-white/80 hover:text-white transition-colors mr-4">
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <div className="mt-4 text-lg text-white/80">
                {subcategoryProducts.length} beers available
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <select 
                id="sort" 
                className="border border-gray-300 rounded-lg px-4 py-2 bg-white focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
              >
          ...
          {subcategoryProducts.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-600 mb-8 max-w-md mx-auto">
                We don't have any {subcategoryData.name.toLowerCase()} in stock right now, but we're constantly adding new beers to our collection.
              </p>

...
export default function GiftTypePage({ params }: GiftTypePageProps) {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl sm:text-2xl text-black/90 max-w-3xl mx-auto">
              Discover our curated selection of {displayType.toLowerCase()} gifts
            </p>
            <div className="mt-8 text-lg text-black/80">
              {isLoading ? 'Loading...' : `${typeProducts.length} gifts available`} • Free delivery for orders above Ksh. 3000
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="text-sm">
            <ol className="list-none p-0 inline-flex">
              ...
              <li className="flex items-center">
                <Link href={`/gifts/${subcategory}`} className="text-gray-500 hover:text-black transition-colors">
      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          {isLoading ? (
            ...
            <div className="text-center">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">No {displayType} gifts found</h2>
              <p className="text-gray-600 mb-6">We're working on adding more {displayType.toLowerCase()} gifts to our collection.</p>
              <Link
                href="/gifts"
            ...
            <>
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-gray-900 mb-4">{displayType} Gift Collection</h2>
                <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                  Discover our carefully selected {displayType.toLowerCase()} gifts for every occasion
                </p>
              </div>
                ...
                {typeProducts.map((product) => (
                  <div key={product.id} className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 overflow-hidden">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-pink-600 font-bold text-lg mb-3">Ksh {product.price.toLocaleString()}</p>

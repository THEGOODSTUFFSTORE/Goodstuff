    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4">The Goodstuff</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/wine" className="hover:text-white transition-colors">Wine</Link>
              </li>
              <li>
                <Link href="/spirits" className="hover:text-white transition-colors">Spirits</Link>
              </li>
              <li>
                <Link href="/beer" className="hover:text-white transition-colors">Beer</Link>
              </li>
              <li>
                <Link href="/mixers" className="hover:text-white transition-colors">Mixers</Link>
              </li>
              <li>

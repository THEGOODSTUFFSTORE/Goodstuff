      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg">
            ...
            {mode !== 'reset' && (
              <div>
                ...
                <input
                  ...
                  className={`appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-red-500 focus:border-red-500 focus:z-10 sm:text-sm ${mode === 'register' ? '' : 'rounded-b-md'}`}
        ...
        {mode === 'login' && (
          <div className="text-sm text-center">
            <Link href="/reset-password" className="font-medium text-red-600 hover:text-red-500">
